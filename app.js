...
app.get('/curriculo', (req, res, next) => {
    res.render('curriculo', {
        ...
        description: 'Auxiliar de tecnologia da informação com experiencia windows e linux',
        experience: [{
            company: 'Unifcv',
            office: 'Auxiliar de T.I.',
            description: 'Trabalho dando suporte aos usuarios docentes, colaboradores e alunos.'
        }],
        education: [{
            instution: 'Feitep',
